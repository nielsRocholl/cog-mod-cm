...
struct ProgressView: View {
    ...
    func averageScore() -> CGFloat {
        print(cognitiveModel.levelScores)
        let totalScore = cognitiveModel.levelScores.reduce(0, +)
        let average = totalScore / CGFloat(cognitiveModel.levelScores.count)
        print(average)
        return average
    }
